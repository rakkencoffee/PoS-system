...
export default function CartNewPage() {
  ...
  const handleCheckout = () => {
    if (isNameValid) router.push('/checkout-new');
  };
    ...
    <div className="min-h-screen bg-[#fff8f2]" style={JKT}>
      ...
      <div className="hidden lg:block">
        ...
        <nav className="sticky top-0 z-50 flex justify-between items-center px-12 py-3 bg-white shadow-sm border-b border-[#f3e0be]/40">
          ...
          <div className="flex items-center gap-8">
            <button
              ...
              className="text-[13px] text-[#998075] hover:text-[#78000f] transition-colors font-[500]"
              style={JKT}
            >
              Menu
            </button>
            <div className="text-[13px] font-bold text-[#78000f] border-b-2 border-[#78000f] pb-0.5" style={JKT}>
              Keranjang
            </div>
            <div className="flex items-center gap-2">
              ...
              >
                <span className="material-symbols-outlined text-[#998075]">shopping_bag</span>
                {itemCount > 0 && (
              ...
              <button className="p-2 hover:bg-[#F5F5F5] rounded-full transition-colors">
                <span className="material-symbols-outlined text-[#998075]">person</span>
              </button>
            </div>
          </div>
        </nav>
        ...
        <main className="max-w-[1440px] mx-auto px-12 py-8 pb-24">
          ...
          {itemCount === 0 ? (
            <EmptyCart onBrowse={() => router.push('/menu-new')} isMobile={false} />
          ) : (
      ...
      <div className="lg:hidden flex flex-col min-h-screen">
        ...
        {itemCount === 0 ? (
          <div className="flex-1">
            <EmptyCart onBrowse={() => router.push('/menu-new')} isMobile />
          </div>
        ) : (
