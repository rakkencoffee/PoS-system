...
export default function MenuNewPage() {
  ...
  // Kept for the mobile input's native onChange event handler.
  const onSearchChange = (e: React.ChangeEvent<HTMLInputElement>) => onSearchValueChange(e.target.value);
  ...
  return (
    <div className="min-h-dvh bg-[#fff8f2] relative" style={JKT}>
