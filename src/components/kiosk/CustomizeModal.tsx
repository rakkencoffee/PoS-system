...
const SUGAR_ICE_CONFIG: Record<string, { sugar: string[]; ice: string[] }> = {
  ...
  'cappuccino': { sugar: ['none', 'more'], ice: ['less', 'normal'] },
  ...
  'rakken milk tea': { sugar: ['less', 'normal'], ice: ['less', 'normal'] },
  'peach milk tea shakerato': { sugar: ['less', 'normal'], ice: ['less', 'normal'] },
  'peach milk tea shakareto': { sugar: ['less', 'normal'], ice: ['less', 'normal'] },
